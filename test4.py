...
def OnTreeViewSelect(TreeViewObj):
    print("Begin")
    for var in TreeViewObj.selection():
        print(TreeViewObj.set(var))
    print("End")
...
class PatternCreateTool(ttk.Frame):
    ...
    def I2C_GUI_Create(self,NotebookMaster):
        ...
        I2C_RegListBox.bind("<<TreeviewSelect>>",OnTreeViewSelect(I2C_RegListBox))
